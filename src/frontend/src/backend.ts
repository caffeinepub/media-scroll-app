...
export class Backend implements backendInterface {
    ...
    async createMediaItem(arg0: MediaItem): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createMediaItem(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async reorderMediaItems(arg0: Array<[bigint, bigint]>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.reorderMediaItems(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateMediaItem(arg0: bigint, arg1: MediaItem): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMediaItem(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
