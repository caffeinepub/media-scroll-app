...
export const idlService = IDL.Service({
  ...
  'createMediaItem' : IDL.Func([MediaItem], [IDL.Nat], []),
  ...
  'updateMediaItem' : IDL.Func([IDL.Nat, MediaItem], [], []),
});
...
export const idlFactory = ({ IDL }) => {
  ...
  const AppSettings = IDL.Record({ 'theme' : IDL.Text, 'appName' : IDL.Text });
