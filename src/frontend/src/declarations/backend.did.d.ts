...
export interface AppSettings { 'theme' : string, 'appName' : string }
...
export interface _SERVICE {
  ...
  'createMediaItem' : ActorMethod<[MediaItem], bigint>,
  ...
  'reorderMediaItems' : ActorMethod<[Array<[bigint, bigint]>], undefined>,
  'saveCallerUserProfile' : ActorMethod<[UserProfile], undefined>,
  'updateAppSettings' : ActorMethod<[AppSettings], undefined>,
  'updateMediaItem' : ActorMethod<[bigint, MediaItem], undefined>,
}
